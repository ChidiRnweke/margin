...
<div
	class="mx-auto max-w-xl rounded-xl border border-border bg-card p-6 text-card-foreground shadow-sm"
>
	<div class="space-y-4">
		<div>
		...
		<!-- Progressive Disclosure -->
		<Collapsible.Root bind:open={isOpen} class="mt-6 w-full">
			...
			<Collapsible.Content class="animate-in slide-in-from-top-2 space-y-4 pt-4 duration-200">
				<div class="grid grid-cols-2 gap-4 rounded-lg border border-border bg-muted/30 p-5">
					<div class="space-y-2">
