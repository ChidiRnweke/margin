...
```svelte
<article
	class="relative rounded-[var(--radius)] border
                border-[hsl(var(--border))] bg-[hsl(var(--surface-paper))] p-6 shadow-[var(--shadow-paper)]"
>
	<span
		class="absolute -top-3 left-6 rotate-[-2deg] rounded-[6px]
	...
	<button
		class="mt-4 rounded-[9999px] bg-[hsl(var(--accent))] px-5 py-2 font-semibold text-[hsl(var(--text))]"
	>
		Add list
	</button>
</article>
...
<div class="flex gap-2">
	<button
		class="rounded-t-[12px] border border-b-0 border-[hsl(var(--border))]
                 bg-[hsl(var(--surface-paper))] px-4 py-2 font-semibold"
	>
		Pantry
	</button>
	<button
		class="rounded-t-[12px] border border-[hsl(var(--border))] bg-[hsl(var(--surface))]
                 px-4 py-2 text-[hsl(var(--text)/0.7)]"
	>
		Freezer
	</button>
</div>
...
```svelte
<input
	class="w-full rounded-[10px] border border-[hsl(var(--border))]
