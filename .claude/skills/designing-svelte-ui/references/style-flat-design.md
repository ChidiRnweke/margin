...
```svelte
<button
	class="rounded-[var(--radius)] bg-[hsl(var(--primary))] px-4 py-2 text-sm
         font-semibold text-[hsl(var(--primary-fg))]
         hover:bg-[hsl(var(--primary)/0.9)] focus-visible:ring-2
         focus-visible:ring-[hsl(var(--primary))] focus-visible:outline-none active:bg-[hsl(var(--primary)/0.82)]"
>
	Continue
</button>
```
...
```svelte
<button
	class="rounded-[var(--radius)] border border-[hsl(var(--border))] bg-[hsl(var(--surface))] px-4
         py-2 text-sm font-semibold
         text-[hsl(var(--text))] hover:bg-[hsl(var(--surface-2))]
         focus-visible:ring-2 focus-visible:ring-[hsl(var(--primary))] focus-visible:outline-none"
>
	Cancel
</button>
```
