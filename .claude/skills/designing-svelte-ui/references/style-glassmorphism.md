...
<div
	class="rounded-[var(--radius)] border border-[hsl(var(--border))]
            bg-[hsl(var(--glass-strong))] p-6 shadow-[var(--shadow-1)] backdrop-blur-xl"
>
...
<nav class="sticky top-4 mx-auto max-w-6xl px-4">
	<div
		class="flex items-center gap-3 rounded-[9999px] border
              border-white/15 bg-white/10 px-4 py-2 shadow-[0_10px_30px_rgba(0,0,0,0.35)] backdrop-blur-xl"
	>
		<a class="text-sm text-white/90" href="#">Home</a>
		<a class="text-sm text-white/60" href="#">Recipes</a>
		<div class="ml-auto">
			<button class="rounded-[9999px] bg-white/15 px-4 py-2 text-sm text-white/90 hover:bg-white/20"
				>Sign in</button
			>
		</div>
	</div>
