...
>
	<div class="mx-auto flex max-w-6xl items-center justify-between px-6 py-3">
		...
		<button class="rounded-[9999px] bg-[hsl(var(--primary))] px-4 py-2 text-white">New</button>
	</div>
</header>
```
...
<div
	class="rounded-[var(--radius)]
            ...
            bg-[var(--acrylic-bg)] p-5
            shadow-[var(--shadow-1)] backdrop-blur-xl"
>
...
```svelte
<div
	class="w-56 rounded-[12px] border border-[hsl(var(--acrylic-border))]
            bg-[var(--acrylic-bg)] p-2 shadow-[var(--shadow-1)] backdrop-blur-xl"
>
	<button class="w-full rounded-[10px] px-3 py-2 text-left hover:bg-black/5">Rename</button>
	<button class="w-full rounded-[10px] px-3 py-2 text-left hover:bg-black/5">Duplicate</button>
	<div class="my-1 h-px bg-[hsl(var(--border))]" />
	<button class="w-full rounded-[10px] px-3 py-2 text-left text-red-600 hover:bg-red-500/10"
		>Delete</button
	>
</div>
```
