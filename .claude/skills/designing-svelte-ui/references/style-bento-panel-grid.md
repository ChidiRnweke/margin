...
<div class="grid gap-4 md:grid-cols-12">
	<section
		class="rounded-[var(--radius)] bg-[hsl(var(--panel))] p-[var(--panel-padding)]
                 shadow-[var(--shadow-panel)] md:col-span-7"
	>
	...
	<section
		class="rounded-[var(--radius)] bg-[hsl(var(--panel))] p-[var(--panel-padding)]
                 shadow-[var(--shadow-panel)] md:col-span-5"
	>
		<h3 class="text-base font-semibold">Quick add</h3>
		<button class="mt-4 rounded-[12px] bg-[hsl(var(--accent))] px-4 py-2 text-white"
			>Scan receipt</button
		>
	</section>
</div>
...
<header class="flex items-start gap-3">
	<div class="grid h-9 w-9 place-items-center rounded-[12px] bg-black/5">◎</div>
	<div>
