...
```svelte
<div
	class="rounded-[var(--radius)] bg-[hsl(var(--surface))]
            p-6 shadow-[var(--neo-raised)]"
>
...
<button
	...
	class="rounded-[9999px] bg-[hsl(var(--surface))] px-5 py-2 text-sm font-semibold
         shadow-[var(--neo-raised)] focus-visible:ring-2
         focus-visible:ring-[hsl(var(--accent))] focus-visible:outline-none data-[pressed=true]:shadow-[var(--neo-pressed)]"
	onclick={() => (isOn = !isOn)}
>
	{isOn ? 'On' : 'Off'}
</button>
