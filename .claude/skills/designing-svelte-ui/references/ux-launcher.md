...
<button
	class="flex w-64 max-w-full items-center gap-2 rounded-md border border-border bg-muted/50 px-3 py-1.5 text-sm text-muted-foreground transition-colors hover:bg-muted"
	onclick={() => (open = true)}
>
	Search documentation...
	<kbd
		class="pointer-events-none ml-auto inline-flex h-5 items-center gap-1 rounded border border-border bg-background px-1.5 font-mono text-[10px] font-medium text-muted-foreground opacity-100 select-none"
	>
