...
>
	<header class="flex items-start justify-between gap-3">
		...
		<button
			class="rounded-[10px] border border-[hsl(var(--border))] px-3 py-1.5 text-sm hover:bg-black/5"
		>
			Manage
		</button>
	</header>
	...
	<div class="mt-4 grid gap-2">
		<div class="flex justify-between text-sm">
			<span>Used this week</span><span class="font-medium">12</span>
		</div>
		<div class="flex justify-between text-sm">
			<span>Expiring soon</span><span class="font-medium">3</span>
		</div>
	</div>
</article>
```
...
<a
	href="#"
	class="block rounded-[var(--radius)] border
         border-[hsl(var(--border))] bg-[hsl(var(--card))]
         p-[var(--card-padding)] shadow-[var(--shadow-card)]
...
>
	...
	<p class="mt-1 text-sm text-[hsl(var(--text)/0.7)]">
		Keep pantry, freezer, and staples separate.
	</p>
</a>
```
