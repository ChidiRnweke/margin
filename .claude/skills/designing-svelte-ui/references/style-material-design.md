...
:root {
	...
	--radius: 12px;
	--elev-0: none;
	--elev-1: 0 1px 2px hsl(0 0% 0% / 0.14), 0 1px 3px hsl(0 0% 0% / 0.1);
	--elev-2: 0 6px 12px hsl(0 0% 0% / 0.14), 0 2px 4px hsl(0 0% 0% / 0.1);
...
```svelte
<div
	class="rounded-[var(--radius)] bg-[hsl(var(--surface-1))]
            p-5 shadow-[var(--elev-1)]
...
```svelte
<button
	class="rounded-[9999px] bg-[hsl(var(--primary))] px-5 py-2.5 text-sm
                font-semibold text-[hsl(var(--primary-fg))]
                hover:bg-[hsl(var(--primary)/0.92)] focus-visible:ring-2
                focus-visible:ring-[hsl(var(--primary))] focus-visible:outline-none active:bg-[hsl(var(--primary)/0.84)]"
>
	Add item
</button>
```
...
```svelte
<div class="fixed inset-0 grid place-items-center bg-black/35">
	<div
		class="w-[min(28rem,90vw)] rounded-[var(--radius)]
              bg-[hsl(var(--surface-1))] p-6 shadow-[var(--elev-3)]"
	>
		...
		<div class="mt-5 flex justify-end gap-2">
			<button class="rounded-[9999px] px-4 py-2">Cancel</button>
			<button class="rounded-[9999px] bg-[hsl(var(--primary))] px-4 py-2 text-white">Save</button>
		</div>
	</div>
</div>
```
