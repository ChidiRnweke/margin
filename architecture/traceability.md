...
| ----------------------------------- | ---------------------------------------------------------------- | --------------------------------------------------------------------------------------------------------------------- | ---------------------------------------------- |
| Identity and access                 | `AUTH-01` to `AUTH-06`, `PRF-01`                                 | `USER`, `SESSION`, `PLANNING_PROFILE`                                                                                 | `INV-001` to `INV-025`                         |
| Aspects and milestones              | `ASP-01` to `ASP-06`, `MLS-01` to `MLS-07`                       | `ASPECT`, `MILESTONE`, `TASK`                                                                                         | `INV-030` to `INV-045`, `INV-050` to `INV-065` |
| Tasks and recurrence                | `TSK-01` to `TSK-11`, `REC-01` to `REC-04`                       | `TASK`, `RECURRING_TASK_SERIES`, `RECURRENCE_RULE`, `RECURRENCE_EXCEPTION`                                            | `INV-050` to `INV-083`, `INV-180` to `INV-185` |
| Availability and planning           | `AVL-01` to `AVL-05`, `PLN-01` to `PLN-06`                       | `AVAILABILITY_BLOCK`, `AVAILABILITY_EXCEPTION`, `PLANNING_CYCLE`, `PLANNING_REVISION`, `TASK_ALLOCATION`, `TASK_LOCK` | `INV-090` to `INV-120`, `INV-187` to `INV-189` |
