...
const SEED_ASPECTS = [
	{
		...
		name: 'Career',
		purpose: 'Professional growth and skill development',
		targetPercentage: 35,
		status: 'Active'
	},
	{
...
const SEED_TASKS = [
	...
	},
	{
		...
		aspectId: SEED_ASPECTS[3].id,
		title: 'Read chapter of design book',
		effortMinutes: 45,
		importanceScore: 40,
		status: 'Backlog'
	}
