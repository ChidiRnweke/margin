...
export interface IAspectService {
  ...
  activateAspect(userId: string, aspectId: string, input: ActivateAspectInput, expectedVersion: number): Promise<unknown>;
  updateAspect(userId: string, aspectId: string, input: UpdateAspectInput, expectedVersion: number): Promise<unknown>;
