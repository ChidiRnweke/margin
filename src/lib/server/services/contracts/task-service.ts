...
export interface ITaskService {
  ...
  updateTask(userId: string, taskId: string, input: UpdateTaskInput, expectedVersion: number): Promise<unknown>;
  moveTaskMilestone(userId: string, taskId: string, milestoneIdOrNone: string | null, expectedVersion: number): Promise<unknown>;
  startTask(userId: string, taskId: string, expectedVersion: number): Promise<unknown>;
  completeTask(userId: string, taskId: string, expectedVersion: number): Promise<TaskCompletionResult>;
