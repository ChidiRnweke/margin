...
export class AspectPurpose {
	...
	constructor(value: string) {
		...
		if (trimmed.length > 2000)
			throw new InputError('Aspect purpose must be 2000 characters or fewer');
		this.value = trimmed;
	}
	toString(): string {
		return this.value;
...
export class MilestoneTitle {
	...
	constructor(value: string) {
		...
		if (trimmed.length > 200)
			throw new InputError('Milestone title must be 200 characters or fewer');
		this.value = trimmed;
	}
	toString(): string {
		return this.value;
...
export class TaskTitleTemplate {
	...
	constructor(value: string) {
		...
		if (trimmed.length > 200)
			throw new InputError('Task title template must be 200 characters or fewer');
		this.value = trimmed;
	}
	toString(): string {
		return this.value;
