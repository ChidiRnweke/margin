...
export type RecurringSeriesStatus =
	(typeof RecurringSeriesStatus)[keyof typeof RecurringSeriesStatus];
...
export type RecurrenceExceptionAction =
	(typeof RecurrenceExceptionAction)[keyof typeof RecurrenceExceptionAction];
...
export type AvailabilityExceptionAction =
	(typeof AvailabilityExceptionAction)[keyof typeof AvailabilityExceptionAction];
...
export type PlanningRevisionStatus =
	(typeof PlanningRevisionStatus)[keyof typeof PlanningRevisionStatus];
...
export type AllocationOutcomeStatus =
	(typeof AllocationOutcomeStatus)[keyof typeof AllocationOutcomeStatus];
...
export type ReminderAttemptResult =
	(typeof ReminderAttemptResult)[keyof typeof ReminderAttemptResult];
